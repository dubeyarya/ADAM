...
def greet_user():
    ...
    if 5 <= hour < 12:
        ...
        speak("Good evening!")
    speak("I'm ADAM . What can I do for you today?")
...
def process_command(command):
    if "time" in command:
        ...
        speak("I am ADAM your personal assistant. I can tell the time, date, play music, search Wikipedia, send emails, and more!")
